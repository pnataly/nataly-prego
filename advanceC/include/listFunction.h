...
/*
 * @brief Predicate function returns 1 if predicate holds for element.
 *
 * @param _element : element to test.
 * @param _context : context to be used.
 * @return 1 if predicate holds.
 */
 ...
 * @return ListItr to the element where the iteration stoped. this might be end iterator, or NULL on NULL input . 
 */
 ...
 * @return an iterator pointing to the first node with data found or to _end if not, or NULL on NULL input.
 */
